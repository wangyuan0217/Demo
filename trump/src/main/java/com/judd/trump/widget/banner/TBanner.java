package com.judd.trump.widget.banner;
...
/**
 * @author 王元_Trump
 * @time 2017/3/14 15:19
 * @desc <com.trump.library.widget.banner.TBanner
 ...
 * <p>
 * 代码
 * TBanner bannerLayout = (TBanner) findViewById(R.id.banner);
 * <p>
 * final List<String> urls = new ArrayList<>();
 * urls.add("http://pic.58pic.com/58pic/11/39/65/71A58PICY4d.jpg");
 * urls.add("http://img4.imgtn.bdimg.com/it/u=1342852777,1560752955&fm=23&gp=0.jpg");
 * bannerLayout.setViewUrls(urls);
 * <p>
 * //添加监听事件
 * bannerLayout.setOnBannerItemClickListener(new TBanner.OnBannerItemClickListener() {
 * @Override public void onItemClick(int position) {
 * Toast.makeText(MainActivity.this, String.valueOf(position), Toast.LENGTH_SHORT).show();
 * }
 * });
 */
public class TBanner extends RelativeLayout {
    ...
    public TBanner(Context context, AttributeSet attrs, int defStyleAttr) {
