 ...
 * Created by Trump on 2015/12/15.
 */
public class ViewPagerHelper {
	...
	public interface OnViewInstantiateListener {
		void onInstantiate(int position, View view);
	}

	/**
	 * @param isAuto
	 *            指定该ViewPager中的内容是否自动滑动，true为自动滑动，false为手动滑动
	 * @param viewPager
	 * @param views
	 *            加载到ViewPager中的View的集合
	 * @param indicatorParents
	 *            导航页下面小圆点的父容器
	 * @param selectDrawableRes
	 *            选中页显示的导航点的图片
	 * @param unselectDrawableRes
	 *            未选中页的导航点的图片
	 */
