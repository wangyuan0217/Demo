...
public final class ImageUtils {
     ...
     * @return drawable
     */
    public static Drawable bytes2Drawable(Context mContext, byte[] bytes) {
     ...
     * @return bitmap
     */
    public static Bitmap getBitmap(Context mContext, int id) {
     ...
     * @return bitmap
     */
    public static Bitmap getBitmap(Context mContext, int id, int maxWidth, int maxHeight) {
        BitmapFactory.Options options = new BitmapFactory.Options();
        options.inJustDecodeBounds = true;
     ...
     * @return 模糊后的图片
     */
    public static Bitmap fastBlur(Context mContext, Bitmap src,
    ...
    public static Bitmap fastBlur(Context mContext, Bitmap src,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            scaleBitmap = renderScriptBlur(mContext, scaleBitmap, radius);
        } else {
    ...
    public static Bitmap renderScriptBlur(Context mContext, Bitmap src, @FloatRange(from = 0, to = 25, fromInclusive = false) float radius) {
        if (isEmptyBitmap(src)) return null;
