 ...
 * <p/>
 * //在任何地方发送广播
 * BroadcastUtil.getInstance(mContext).sendBroadcast(FindOrderActivity.ACTION_RECEIVE_MESSAGE);
 * <p/>
 * //页面在oncreate中初始化广播
 * BroadcastUtil.getInstance(mContext).addAction(ACTION_RECEIVE_MESSAGE, new BroadcastReceiver(){
 *
 * @author huxinwu
 * @version 1.0
 ...
 * <p/>
 * //页面在ondestory销毁广播
 * BroadcastUtil.getInstance(mContext).destroy(ACTION_RECEIVE_MESSAGE);
 * @date 2015-9-17
 **/
